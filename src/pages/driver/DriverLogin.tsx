    ...
    <div className="flex min-h-screen items-center justify-center bg-background px-4">
      ...
      >
        ...
        <div className="mb-10 flex flex-col items-center">
          ...
          <p className="mt-1 text-sm text-muted-foreground">Driver Portal</p>
        </div>

        {/* Login Card */}
        <div className="glass-card-solid p-6">
          <h2 className="mb-1 text-lg font-bold text-foreground">Welcome back</h2>
          <p className="mb-6 text-sm text-muted-foreground">Sign in to start your shift</p>

          <form onSubmit={handleLogin} className="space-y-4">
            <div>
              <label className="mb-1.5 block text-xs font-medium text-muted-foreground">Driver ID or Email</label>
              <div className="relative">
                <User className="absolute left-3 top-1/2 h-4 w-4 -translate-y-1/2 text-muted-foreground" />
                <input
                  type="text"
                  placeholder="Enter your ID..."
                  defaultValue="DRV-001"
            ...
            <Button type="submit" variant="driver" size="xl" className="w-full mt-2">
              Sign In
            </Button>
          </form>
